    ...
    return (
        <footer>
            ...
            <ul className={css.social_icon}>
                <li><a href="https://www.instagram.com/abdugafforovv.o1">
                    <svg
                ...
                <li><a href="https://t.me/abdugafforov_x">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="26"
                        height="26"
                ...
                <li><a href="https://xislatbekdeveloper05@gmail.com">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="26"
                        height="26"
                ...
                <li><a href="https://github.com/abdugafforov01">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="26"
                        height="26"
            ...
            <p>© 2023 Abdugafforov Xislatbek | Portfolio</p>
        </footer>
    )
}
